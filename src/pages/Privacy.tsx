      ...
      },
      {
        ...
        body: (
          <>
            ...
            <p>You also play a critical role in keeping your account safe. Choose a strong, unique password, enable multi-factor authentication, never share credentials, log out of shared devices, and notify us immediately at security@geflow.io if you suspect any unauthorized access.</p>
          </>
        ),
      },
      {
        ...
        body: (
          <>
            ...
            <p><strong className="text-foreground">Right of Access.</strong> You may request a copy of the personal information we hold about you. Most data is directly accessible inside your workspace; for everything else, contact privacy@geflow.io and we will respond within 30 days.</p>
            ...
            <p>To exercise any of these rights, email privacy@geflow.io. We may need to verify your identity before fulfilling the request to protect your data from unauthorized disclosure.</p>
          </>
        ),
      },
      {
        ...
        body: (
          <>
            ...
            <p>Historical versions of this Policy are archived and available upon request at privacy@geflow.io. We encourage you to review this Policy periodically — at a minimum, every six months — to remain informed about how we are protecting your information.</p>
            <p>If you have any questions, comments, or concerns about this Privacy Policy or our data-handling practices, please contact our Data Protection Officer at privacy@geflow.io or by postal mail at: GeFlow / Gepard Tech, Attn: Data Protection Officer, 1 Innovation Plaza, Suite 400.</p>
          </>
        ),
      },
    ]}
