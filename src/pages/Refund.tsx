      ...
      },
      {
        ...
        body: (
          <>
            ...
            <p><strong className="text-foreground">30-Day Evaluation Window.</strong> All Lifetime plan purchases include an unconditional 30-day evaluation window. Within these 30 days, you may request a full refund for any reason by emailing billing@geflow.io. Refunds will be processed within 5 to 10 business days using the original payment method.</p>
      ...
      },
      {
        ...
        body: (
          <>
            ...
            <p>To claim a service credit, contact billing@geflow.io within 30 days of the affected billing period. Credits are applied automatically to your next invoice and do not expire while your subscription remains active.</p>
          </>
        ),
      },
      {
        ...
        body: (
          <>
            <p>If you have a billing concern, please contact us at billing@geflow.io before initiating a chargeback or payment dispute with your card issuer. We resolve the vast majority of billing inquiries within one business day, often faster than a chargeback can be processed.</p>
      ...
      },
      {
        ...
        body: (
          <>
            ...
            <p>If you have any questions about this Refund Policy or wish to request a refund, please contact billing@geflow.io. Our team is available Monday through Friday, 9:00 AM to 8:00 PM (UTC), and we typically respond within one business day.</p>
          </>
        ),
      },
    ]}
