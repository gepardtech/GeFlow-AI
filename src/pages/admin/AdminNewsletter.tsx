            ...
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              {editingTemplate ? (
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="p-4 sm:p-6 rounded-2xl border border-border bg-muted/30 space-y-3 w-full overflow-hidden">
                    ...
                    <div className="w-full max-w-xl mx-auto rounded-2xl border border-border bg-card shadow-lg overflow-hidden">
                      ...
                      <div className="bg-muted px-4 py-2.5 border-b border-border flex items-center justify-between text-xs text-muted-foreground">
                        <div className="flex items-center gap-2 min-w-0">
                          <span className="h-2.5 w-2.5 rounded-full bg-rose-400 inline-block flex-shrink-0" />
                          <span className="h-2.5 w-2.5 rounded-full bg-amber-400 inline-block flex-shrink-0" />
                          <span className="h-2.5 w-2.5 rounded-full bg-emerald-400 inline-block flex-shrink-0" />
                          <span className="ml-2 font-medium truncate">To: subscriber@example.com</span>
                        </div>
                        <span className="font-mono text-[10px] flex-shrink-0">GeFlow Mailer</span>
                      </div>

                      <div className="p-4 sm:p-6 space-y-4 break-words">
                        <div className="border-b border-border/60 pb-3">
                          <div className="text-[11px] font-semibold text-muted-foreground">Subject:</div>
                          <div className="font-bold text-sm sm:text-base text-foreground break-words mt-0.5">
                            {editingTemplate.subject.replace(/{{app_name}}/g, appName)}
                          </div>
                        </div>

                        {editingTemplate.headline && (
                          <div className="text-base sm:text-lg font-extrabold text-foreground tracking-tight break-words">
                            {editingTemplate.headline}
                          </div>
                        )}

                        <div className="text-xs sm:text-sm text-muted-foreground whitespace-pre-line leading-relaxed break-words">
                        ...
                        {editingTemplate.ctaText && (
                          <div className="pt-2">
                            <div className="inline-block max-w-full truncate px-5 py-2.5 rounded-xl bg-sky-500 text-white font-bold text-xs shadow-md text-center">
                              {editingTemplate.ctaText}
                            </div>
                          </div>
                        )}
